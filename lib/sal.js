...
// request.debug = true;    // turn on debugging for request library
...
//console.log('AD.sal.http(): ');
    ...
    if ((args.contentType == 'application/json')
        ...
        opts.json = args.data;
        // opts.body = args.data; //JSON.stringify(args.data);

        // make sure headers have: 'Content-type' : 'application/json'
...
//         // maybe we've already stringified it:
...
//                 opts.body = args.data;
// console.log(err);
// console.log('*** error parsing json:', args.data);
//             }
//         }
